...
if __name__ == "__main__":
    test = [[-200, -40, 162.3], [-1103, 0, -166.0]]

    enigmatica6_world3 = [[5687, 919, -179.9], [4931, 908, -144.6]]

    AOF5_world8 = [[139.613, 32.967, 73.4], [89.282, 1333.258, 123.6]]

    AOF6_kermit = [
        # x, z, theta
        [-208.791, 194.457, 119],
        [-628.609, -1038.726, 77.6],
        [-1919.7, -753.326, 119.6],
    ]

    pprint(find_end(AOF6_kermit))
